...
<div class="dashboard-container form-container">
    <div class="dashboard-header">
        <div class="header-title">
            <h1 class="glow-text">Edit Pengguna</h1>
            <p>Perbarui informasi pengguna: {{ $user->name }}</p>
        </div>
    ...
    <div class="glass-card">
        <form action="{{ route('dashboard.update', $user->id) }}" method="POST" class="custom-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="name" name="name" class="glass-input @error('name') is-invalid @enderror" value="{{ old('name', $user->name) }}" placeholder="Masukkan nama lengkap" required>
                </div>
                @error('name')
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" id="email" name="email" class="glass-input @error('email') is-invalid @enderror" value="{{ old('email', $user->email) }}" placeholder="contoh@email.com" required>
                </div>
                @error('email')
                    <span class="error-msg">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" id="password" name="password" class="glass-input @error('password') is-invalid @enderror" placeholder="Kosongkan jika tidak ingin diubah">
                </div>
                @error('password')
                    <span class="error-msg">{{ $message }}</span>
                @enderror
